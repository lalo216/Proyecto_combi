            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Permisos de ubicación', style: tt.titleSmall),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        Container(
                          ...
                          height: 12,
                          decoration: BoxDecoration(
                            color: _hasLocationPermission == true
                                ? Colors.green
                                : Colors.red,
                            shape: BoxShape.circle,
                          ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () async {
                          ...
                          if (mounted) {
                            // Recargar estado después de que el usuario regrese de Settings
                            await Future.delayed(const Duration(milliseconds: 500));
                            await _loadStatus();
                          }
                        },
                        icon: const Icon(Icons.location_on),
                        label: const Text('Cambiar en Configuración'),
                      ),
                    ),
                  ],
                ),
