...
// Pantalla de perfil:
//   - Sin sesión: formulario de login + link a CrearCuentaPage
//   - Con sesión: datos del usuario (incluye saludo con nombre) y logout
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                estado.userPrimerNombre.isEmpty
                    ? 'Hola'
                    : '¡Hola, ${estado.userPrimerNombre}!',
                style: tt.titleLarge?.copyWith(fontWeight: FontWeight.bold),
                textAlign: TextAlign.center,
              ),
              if ((estado.userNombreCompleto ?? '').isNotEmpty) ...[
                const SizedBox(height: 4),
                Text(
                  estado.userNombreCompleto!,
              ...
              if ((estado.userMunicipio ?? '').isNotEmpty) ...[
                const SizedBox(height: 4),
                Text(
                  estado.userMunicipio!,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton.icon(
                        ...
                        label: const Text('¿Nuevo aquí? Crear cuenta'),
                      ),
                    ],
                  ),
                ),
